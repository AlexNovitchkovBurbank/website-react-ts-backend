...
describe('rest/index.js', () => {
  it('should save', () => client.put('/metrics/00000000-0000-0000-0000-000000000000')
    .send(THING)
  ...
  it('should get', () => client.get('/metrics/00000000-0000-0000-0000-000000000000')
    // .set('Authorization', JWT)
    .expect(200)
    .expect((res) => {
      // console.log('RES: %s', JSON.stringify(res, null, 2));
  ...
  it('should query', () => client.get('/metrics')
    // .set('Authorization', JWT)
    .expect(200)
    .expect((res) => {
      // console.log('RES: %s', JSON.stringify(res, null, 2));
  ...
  it('should delete', () => client.delete('/metrics/00000000-0000-0000-0000-000000000000')
    // .set('Authorization', JWT)
    .expect(200)
    .expect((res) => {
      // console.log('RES: %s', JSON.stringify(res, null, 2));
