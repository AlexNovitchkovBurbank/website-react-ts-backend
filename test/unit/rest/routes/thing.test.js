...
describe('rest/routes/thing.js', () => {
  ...
  it('should save', async () => {
    ...
    const data = await saveMetric(request, response);
  ...
  it('should get by id', async () => {
    ...
    const data = await getMetric(request, response);
  ...
  it('should query', async () => {
    ...
    const data = await queryMetrics(request, response);
  ...
  it('should delete', async () => {
    ...
    const data = await deleteMetric(request, response);
